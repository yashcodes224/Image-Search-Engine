...
type BackupConfig = definitions['BackupConfig'];
type RestoreConfig = definitions['RestoreConfig'];
...
interface NearVectorSubSearch {
    vector: number[];
    certainty?: number;
    distance?: number;
    targetVectors?: string[];
}
interface HybridSubSearch {
...
declare class TenantsExists extends CommandBase {
    private className;
    private tenant;
